...
/******/ (function (modules) {
  ...
  /******/ [
            ...
            },
            {
              ...
              value: function _bindMouse() {
                ...
                function showContextMenu(x, y, selectedText) {
                  ...
                  const commentItem = createMenuItem("Add Comment", () => {
                    // Handle adding a text comment
                    addTextComment(selectedText);
                    contextMenu.remove();
                  });

                  const highlightItem = createMenuItem("Highlight", () => {
                    // Handle highlighting the selected text
                    highlightSelectedText(selectedText);
                    contextMenu.remove();
                  });

                  // Add menu items to the context menu
                  contextMenu.appendChild(commentItem);
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      // function showContextMenu(x, y, selectedText) {
      //   console.log("232332 select menu 34343");
